...
const faqItems = [
  ...
  ['What is the Generated Website?', `The Generated Website is a separate optional website product created using your business information. You can currently try it free for ${GENERATED_WEBSITE_PRODUCT.trialDays} days before deciding whether to continue.`],
