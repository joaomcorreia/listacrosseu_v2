...
import GeneratedWebsiteTemplate, { GeneratedWebsite } from './GeneratedWebsiteTemplate';
...
export default function PremiumPreviewClient({ businessId, lang }: { businessId: string; lang: string }) {
  ...
  return <GeneratedWebsiteTemplate initial={website} businessId={businessId} lang={lang} />;
}
