...
export default function PricingPageClient({ lang }: { lang: string }) {
  return (
    <>
      <section className="py-16"><Container><div className="mx-auto max-w-3xl text-center"><h1 className="text-4xl font-black text-slate-900">{GENERATED_WEBSITE_PRODUCT.name}</h1><p className="mt-4 text-lg text-slate-600">Edit your generated website before payment and publishing.</p></div><div className="mx-auto mt-12 max-w-xl"><article className="rounded-2xl border border-blue-600 bg-white p-7 shadow-sm ring-2 ring-blue-100"><h2 className="text-xl font-bold text-slate-900">Choose your language plan</h2><p className="mt-3 text-sm text-slate-600">A simple generated website for a claimed ListAcrossEU business listing.</p><div className="mt-7 grid gap-3 sm:grid-cols-2"><p className="rounded-lg bg-slate-50 p-3 text-lg font-black text-slate-900">1 language<br /><span className="text-sm font-semibold">{GENERATED_WEBSITE_PRODUCT.priceOneLanguage}</span></p><p className="rounded-lg bg-slate-50 p-3 text-lg font-black text-slate-900">Up to 4 languages<br /><span className="text-sm font-semibold">{GENERATED_WEBSITE_PRODUCT.priceFourLanguages}</span></p></div><Link href={publicActionHref(lang, 'TRY_GENERATED_WEBSITE')} className="mt-7 inline-flex w-full items-center justify-center rounded-lg bg-slate-900 px-4 py-3 text-sm font-bold text-white hover:bg-slate-800">{GENERATED_WEBSITE_PRODUCT.cta}</Link></article></div></Container></section>
